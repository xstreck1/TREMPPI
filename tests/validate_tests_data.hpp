...
protected:
	...
	void SetUp() override {
		...
		a_spike_on_A.states.emplace_back(PropertyAutomaton::State{ "1", 1, true });
		a_spike_on_A.states[1].edges = vector < PropertyAutomaton::Edge >{ PropertyAutomaton::Edge{ 1, "tt" } };
		...
		a_is_steady.states.emplace_back(PropertyAutomaton::State{ "0", 0, true });
		a_is_steady.states[0].edges = vector < PropertyAutomaton::Edge >{ PropertyAutomaton::Edge{ 0, "tt" } };
		...
		a_cycle_on_A.states.emplace_back(PropertyAutomaton::State{ "0", 0, true });
		a_cycle_on_A.states[0].edges = vector < PropertyAutomaton::Edge > { PropertyAutomaton::Edge{ 1, "tt" } };
		a_cycle_on_A.states.emplace_back(PropertyAutomaton::State{ "1", 1, false });
		a_cycle_on_A.states[1].edges = vector < PropertyAutomaton::Edge >{ PropertyAutomaton::Edge{ 0, "A=1" }, PropertyAutomaton::Edge{ 1, "A=0" } };
