...
protected:
	...
	void SetUp() override {
		...
		a_cycle_on_A.states.emplace_back(PropertyAutomaton::State{ "0", 0, false, { PropertyAutomaton::Edge{ 0, "A=0" }, PropertyAutomaton::Edge{ 1, "A=1" } } });
		a_cycle_on_A.states.emplace_back(PropertyAutomaton::State{ "1", 1, false, { PropertyAutomaton::Edge{ 1, "A=1" }, PropertyAutomaton::Edge{ 2, "A=0" } } });
