...
folder_types = ["common", "browse", "properties", "editor", "select", "witness", "report"]
...
shutil.copy(join(HOME_PATH, os.path.normpath("javascript/browse.html")), DEST_PATH)
